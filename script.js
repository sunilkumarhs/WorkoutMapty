...
class App {
  ...
  _loadMap(position) {
    ...
    console.log(
      `https://www.google.com/maps/@${latitude},${longitude},10z?authuser=0&entry=ttu`
    );
  ...
  _newWorkout(e) {
    ...
    if (type === 'cycling') {
      ...
      if (
        !validateInput(distance, duration, elivation) ||
        !allPositive(distance, duration)
      )
        return alert('Inputs should be a positive !');
  ...
  _renderWorkout(workout) {
    ...
    <div class="workout__details">
      <span class="workout__icon">⛰</span>
      <span class="workout__value">${workout.elivationGain}</span>
